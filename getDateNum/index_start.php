...
// описание массива параметров нашего собственного действия
        var params = {
            ...
            'HANDLER': 'https://spa-bitrix.ru/webhooks/activities/getDateNum/getDateNum.php',// скрипт-обработчик действия
            ...
            'NAME': {
                'ru': 'Получить день недели, номер недели, номер месяца' // название действия в редакторе БП
            },
            'DESCRIPTION': {
                'ru': 'Получить день недели, номер недели, номер месяца' // описание действия в редакторе БП
            },
